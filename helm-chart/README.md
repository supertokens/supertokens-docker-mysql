...
| database.host | string | `"mysql"` | database host address |
...
| database.connectionPoolSize | int | `5` | maximum mysql connection pool size |
...
| image.repository | string | `"supertokens/supertokens-mysql"` | docker repository |
